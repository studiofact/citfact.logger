...
class citfact_logger extends CModule
{
    /**
     * @var string
     */
    public $MODULE_ID = 'citfact.logger';
    ...
    {
        $this->MODULE_NAME = Loc::getMessage('LOGGER_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('LOGGER_MODULE_DESCRIPTION');
